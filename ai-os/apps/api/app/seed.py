...
AGENTS = [
    {"id": "a1", "name": "Planner", "model": "claude-opus-4-8", "state": "done",
     ...
     "skills": ["plan.decompose", "common.inspect_first", "common.safe_report"],
    ...
    {"id": "a2", "name": "Researcher", "model": "gemini-2.5-pro", "state": "done",
     ...
     "skills": ["research.untrusted", "data.shape_check", "common.inspect_first", "common.safe_report"],
    ...
    {"id": "a3", "name": "Builder", "model": "claude-opus-4-8", "state": "run",
     ...
     "skills": ["build.small_steps", "build.test_before_done", "common.inspect_first",
    ...
    {"id": "a4", "name": "Reviewer", "model": "gpt-5", "state": "idle",
     ...
     "skills": ["review.read_only", "review.triage_failures", "common.safe_report"],
    ...
    {"id": "a5", "name": "Executor", "model": "claude-opus-4-8", "state": "idle",
     ...
     "skills": ["exec.approval_first", "common.safe_report"],
