...
MODELS = ["claude-opus-4-8", "gemini-2.5-pro", "gpt-5", "claude-haiku-4-5"]

AGENTS = [
    {"id": "a1", "name": "Planner", "preset": "preset.planner", "model": "claude-opus-4-8", "state": "done",
    ...
    {"id": "a2", "name": "Researcher", "preset": "preset.researcher", "model": "gemini-2.5-pro", "state": "done",
    ...
    {"id": "a3", "name": "Builder", "preset": "preset.builder", "model": "claude-opus-4-8", "state": "run",
    ...
    {"id": "a4", "name": "Reviewer", "preset": "preset.reviewer", "model": "gpt-5", "state": "idle",
    ...
    {"id": "a5", "name": "Executor", "preset": "preset.executor", "model": "claude-opus-4-8", "state": "idle",
