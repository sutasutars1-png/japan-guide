...
export const CATS = [
  { key:"あそび場・体験", emoji:"🎡", tile:"#FFE7DE", grad:"linear-gradient(135deg,#FF9A76,#F0603D)", tags:["室内","雨の日OK"], ageMin:0, indoor:true },
  { key:"動物とふれあう", emoji:"🦁", tile:"#E4F5EC", grad:"linear-gradient(135deg,#5BC7A0,#22A6A0)", tags:["動物"],           ageMin:0, indoor:false },
  { key:"学ぶ・科学館",   emoji:"🔬", tile:"#E7F1FB", grad:"linear-gradient(135deg,#6FB1F0,#3E7FD0)", tags:["学ぶ","雨の日OK"], ageMin:2, indoor:true },
  { key:"公園でのびのび", emoji:"🌳", tile:"#EAF7F6", grad:"linear-gradient(135deg,#7BC96F,#4CA64C)", tags:["屋外","のびのび"], ageMin:0, indoor:false },
  { key:"水あそび",       emoji:"💧", tile:"#E6F6FA", grad:"linear-gradient(135deg,#4FD1C5,#2AA6B8)", tags:["水あそび","夏"],   ageMin:0, indoor:false },
  { key:"美術・文化",     emoji:"🎨", tile:"#FBEBF0", grad:"linear-gradient(135deg,#E58FB0,#C86A93)", tags:["アート","雨の日OK"], ageMin:2, indoor:true },
  { key:"観光・名所",     emoji:"🏰", tile:"#F0ECFB", grad:"linear-gradient(135deg,#A99BE0,#7C6BC0)", tags:["おでかけ"],       ageMin:0, indoor:false },
];
